...
# Fix up activitysync import here. We would normally install activitysync,
# but this is an example included in the activitysync repository. Rather than
# also needing to install it or add it to PYTHONPATH, let's fix it up here.
...
SECRET_KEY = 'zozod)o0k870ovq(%^tz$^illmbnyja32z#v6xj1vx)l-pn9sq'
...
ROOT_URLCONF = 'activitydisplay.urls'

TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'templates'),
    os.path.join(BASE_DIR, '../../activitysync/templates'),
)
